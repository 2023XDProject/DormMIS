...
public interface SchoolAdmMapper {
    //根据stuid查询学生个人信息并分页
    ...
    //注册用户
    Boolean userRegister(@Param("user") SchoolAdm user);

    //用户登陆
    Boolean userLogin(@Param("uid") String uid,@Param("pwd") String pwd);

    Integer update(Object o, LambdaUpdateWrapper<SchoolAdm> lambdaUpdateWrapper);
}
