...
public class PaymentServiceImpl extends ServiceImpl<PaymentMapper,Payment> implements PaymentService {
    ...
    public Page<Payment> getPaymentByDate(Page<Payment> page, String year, String month) {
        return paymentMapper.getPaymentByDate(page,year);
    }

    @Override
    public Page<Payment> getPaymentByStuNo(Page<Payment> page, String stu_ID){
        return paymentMapper.getPaymentByDate(page, stu_ID);
    }
